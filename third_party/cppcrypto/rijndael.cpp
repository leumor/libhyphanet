...
namespace cppcrypto {
static const std::array<uint32_t, 32> RC{
...
static const std::array<unsigned char, 256> S{
...
static const std::array<unsigned char, 256> IS{
...
static const std::array<std::array<uint32_t, 256>, 4> T{
    {{
...
static const std::array<std::array<uint32_t, 256>, 4> IT{
    {{
