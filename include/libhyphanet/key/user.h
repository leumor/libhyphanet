...
namespace impl {
     ...
     */
    class LIBHYPHANET_EXPORT Key : public virtual key::user::Key {
    protected:
        /**
    ...
    public:
         ...
         * @return The routing key as a vector of bytes.
         */
        [[nodiscard]] std::vector<std::byte> get_routing_key() const final
        {
            return routing_key_;
        }
         ...
         * @return The crypto algorithm as an enum value.
         */
        [[nodiscard]] Crypto_algorithm get_crypto_algorithm() const final
        {
     ...
     * so a user can use it to insert new versions of data.
     */
    class LIBHYPHANET_EXPORT Insertable : public virtual key::user::Insertable {
    public:
        /**
     ...
     *
     */
    class LIBHYPHANET_EXPORT Subspace_key
        : public virtual key::user::Subspace_key,
          public Key {
    public:
        /**
        ...
        [[nodiscard]] std::string get_docname() const final { return docname_; }
